...
**Keşifsel Analiz**
- Prim dağılımı (normal ve log ölçeği)
- Korelasyon matrisi
...
Kaynak: [Kaggle — Medical Insurance Cost Dataset](https://www.kaggle.com/datasets/mosapabdelghany/medical-insurance-cost-dataset)
